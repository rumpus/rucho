// patch.rs
use axum::{routing::patch, Router, extract::{Json, Query}, http::HeaderMap, response::IntoResponse};
...
pub fn router() -> Router {
    Router::new().route("/patch", patch(patch_handler))
}

async fn patch_handler(headers: HeaderMap, Query(pretty_query): Query<PrettyQuery>, body: Result<Json<Payload>, axum::extract::rejection::JsonRejection>) -> impl IntoResponse {
