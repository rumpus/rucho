// delete.rs
use axum::{routing::delete, Router, extract::{Json, Query}, http::HeaderMap, response::IntoResponse};
...
pub fn router() -> Router {
    Router::new().route("/delete", delete(delete_handler))
}

async fn delete_handler(headers: HeaderMap, Query(pretty_query): Query<PrettyQuery>, body: Result<Json<Payload>, axum::extract::rejection::JsonRejection>) -> impl IntoResponse {
